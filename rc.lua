...
--	--add and name the tags
--	tag[s][tagnumber] = tag(tagnames[tagnumber])
--	--Give tags their layouts
--	tag[s][tagnumber].screen = s
--	awful.layout.set(taglayout[1], tags[s][tagnumber])
--    end
